...
export const TASK_FIELDS = 'id, title, description, due_date, user_id, property_id, file_id, recur_frequency, recur_anchor, completed_at, system, severity, location, issue, fix_recommendation, cost_min, cost_max, timing_note, recurrence, catalog_id, recur_interval, source_page, cost_confidence, task_kind';
...
function taskInputToRow(input: TaskInput) {
  return {
    ...
    recur_interval: input.recurInterval ?? 1,
